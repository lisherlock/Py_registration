...
if __name__ == '__main__':
    ...
    if not os.path.exists('data_info.csv'):
        ...
        ori_image_path = data_info['ori_image_path'].tolist()[0]
        target_image_path = data_info['target_image_path'].tolist()[0]
        output_file_path = os.path.join(data_info['output_path'].tolist()[0], data_info['output_file_name'].tolist()[0])
